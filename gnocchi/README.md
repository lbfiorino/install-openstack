...
`<server-id>` é o _id_ da instância no Openstack, que pode ser recuperado através do comando `openstack server list`.  
Esse _id_ é o _resource-id_ da instância no gnocchi.
